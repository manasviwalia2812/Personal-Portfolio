...
export const EXPERIENCES = [
  {
    ...
    description: `Worked on multiple web development projects, contributing to both frontend and backend development. Built and styled responsive web pages, implemented dynamic functionality, and integrated databases to support real-world use cases. Collaborated with the development team to debug issues, optimize performance, and deliver reliable solutions, while strengthening problem-solving, teamwork, and adaptability.`,
